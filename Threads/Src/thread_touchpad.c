...
static gt911_config_t gt911_config = {
    ...
    .gap1      = {0x00, 0x00},
    .sensor_ch = {0x02, 0x04, 0x06, 0x08, 0x0A, 0x0C, 0x0E, 0x10, 0x12, 0x14, 0x16, 0x18, 0x1A,
                  0x1C},
    .gap2 = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
             0xFF, 0xFF},
    .driver_ch = {0x00, 0x02, 0x04, 0x06, 0x08, 0x0A, 0x0C, 0xF,  0x10, 0x12, 0x13, 0x14, 0x16,
                  0x18, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21, 0x22, 0x24, 0x26, 0x28, 0x29, 0x2A},
    ...
    .gap3   = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
               0xFF, 0xFF},
    .chksum = 0x00,
    .fresh  = 0x01,
};
...
HAL_StatusTypeDef gt911_read_pid()
{
  ...
  status = Bambloo_I2C_Mem_Read(gt911_address, 0x8140, info_bytes, sizeof(info_bytes), 2);
...
reinit:
  ...
  while (1) {
    tx_event_flags_get(&touchpad_efg, 0x01, TX_AND_CLEAR, &flags, TX_WAIT_FOREVER);
